/**
 * GitHub Issue Monitor with Coordinator Automation
 * Uses Claude Code's native capabilities for GitHub interaction
 */
...
class GitHubMonitor {
    ...
    async init() {
        console.log('🚀 Initializing GitHub Monitor with Coordinator...');
        ...
        this.automation = new GitHubAutomationCoordinator(this.config);
            ...
            for (const [index, issue] of issuesToProcess.entries()) {
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        console.log(`❌ Failed to process issue #${issue.number}: ${result.error}`);
                    }
