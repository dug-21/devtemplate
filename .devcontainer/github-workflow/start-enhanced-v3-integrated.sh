...
# Check if the integrated monitor exists
if [ -f "monitor-enhanced-v3-integrated.js" ]; then
    node monitor-enhanced-v3-integrated.js
else
    echo "❌ Error: monitor-enhanced-v3-integrated.js not found"
